...
export default function Home() {
  ...
  return <main className="app-shell">
    <header className="topbar"><div className="brand"><div className="brand-mark">DreamMotion</div></div><div className="top-actions"><button className="ghost-button" onClick={resetDocument}>Сбросить всё</button><button className="ghost-button" onClick={printDocument}>Сохранить PDF</button><button className="primary-button" onClick={downloadDocument}>Скачать договор</button></div></header>
